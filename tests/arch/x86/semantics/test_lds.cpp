...
TEST_F(x86_semantics_test, LDS)
{
    ...
    struct operand* src = make_memory_operand_direct(&memop, &as, register_file, 4, X86_REG_DS, 0x0);

    DS(register_file) = 0x0;
    word val1 = 0x1234;
    word val2 = 0x5678;
    address_space_access_segmented(&as, 1, DS(register_file), 0x0, 2, (byte*)&val1);
    address_space_access_segmented(&as, 1, DS(register_file), 0x2, 2, (byte*)&val2);
