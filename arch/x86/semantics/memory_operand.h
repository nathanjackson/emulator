...
struct operand* make_memory_operand_indirect(struct memory_operand* out, struct address_space* as, struct x86_register_file*, size_t size, x86_reg seg, x86_reg, word disp);
